...
class EXTRACTSECTIONS:
    def __init__(self, file):
        self.sectiondata = {"Start of Crashinfo Collection":[], "Show Alignment":[], "Malloc and Free Traces":[],"Stack Trace":[],"Context":[], "Stack Dump":[], "Process Level Info":[], "Interrupt Level Stack Dump":[],"Interrupt Stack":[],"Register Memory Dump":[],"show chunk failures":[]}
        self.file = file
